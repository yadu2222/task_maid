            ...
            child: Stack(
              children: [
                                                          ...
                                                          children: [
                                                            ...
                                                            Container(
                                                                ...
                                                                child: Column(children: [
                                                                  ...
                                                                  // タスク内容の表示
                                                                  CustomText(
                                                                      text: items.taskList['id'][messages['index']]
                                                                          ['task'],
                                                                      fontSize: _screenSizeWidth * 0.035,
                                                                      color: Constant.blackGlay),
                                                                ])),
                                                                      ...
                                                                      InkWell(
                                                                        onTap: () {
                                                                          ...
                                                                          addMessage(
                                                                              ...
                                                                              0,
                                                                              true,
                                                                              items.message['sender'][messenger][index]
                                                                                  ['index'],
                                                                              false);
                                                                        ...
                                                                        child: Container(
                                                                          ...
                                                                          padding:
                                                                              EdgeInsets.all(_screenSizeWidth * 0.01),
                                                                          alignment: const Alignment(0.0, 0.0),
                                                                          decoration: BoxDecoration(
                                                                              color: Constant.white,
                                                                              borderRadius: BorderRadius.circular(10)),
                                                                          child: CustomText(
                                                                              text: '順調です！！！！！！',
                                                                              fontSize: _screenSizeWidth * 0.03725,
                                                                              color: Constant.blackGlay),
                                                                        ),
                                                                      ),
                ...
                Align(
                    ...
                    child: Container(
                        width: _screenSizeWidth,
                        height: items.indexBool ? _screenSizeHeight * 0.11 : _screenSizeHeight * 0.0578,
                          ...
                          Row(
                            children: [
                                                    ...
                                                    child: Column(
                                                      children: [
                                                        ...
                                                        Container(
                                                            ...
                                                            child: ListView(
                                                                children:
                                                                    (items.taskList['id'] as List<Map<String, dynamic>>)
                                                                        .map<Widget>((item) {
                                                              int quoteIndex =
                                                                  (items.taskList['id'] as List<Map<String, dynamic>>?)
                                                                          ?.indexOf(item) ??
                                                                  ...
                                                                  title: item['user'] == messenger
                                                                      ? InkWell(
                                                                          ...
                                                                          child: Container(
                                                                            ...
                                                                            padding:
                                                                                EdgeInsets.all(_screenSizeWidth * 0.02),
                                                                            decoration: BoxDecoration(
                                                                                color: Constant.white,
                                                                                borderRadius:
                              ...
                              Container(
                                ...
                                // alignment: const Alignment(0.0, 0.0),
                                margin:
                                    EdgeInsets.only(left: _screenSizeWidth * 0.035, right: _screenSizeWidth * 0.035),
                              ...
                              IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (_messageController.text.isNotEmpty) {
                                    ...
                                    // メッセージ追加メソッド呼び出し
                                    addMessage(
                                        messenger, true, message, false, 0, 5, items.indexBool, items.taskIndex, false);
