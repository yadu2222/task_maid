                      ...
                      title: item['bool']
                          ...
                          : InkWell(
                                                          ...
                                                          child: Row(children: [
                                                            ...
                                                            InkWell(
                                                              onTap: () {
                                                                // 見ているタスクを引用してリスケを希望
                                                                // 辞書に追加
                                                                addMessage(item['user'], true, 'できました！！！！！！！', false, 0,
                                                                    0, true, index, false);
                                                            ...
                                                            InkWell(
                                                              onTap: () {
                                                                // 見ているタスクを引用してリスケを希望
                                                                // 辞書に追加
                                                                addMessage(item['user'], true, 'リスケお願いします', false, 0, 0,
                                                                    true, index, false);
                                                                items.indexBool = false;
                                                                // ページ遷移
                                                                Navigator.push(
                              ...
                              child: Container(
                                  ...
                                  padding:
                                      EdgeInsets.only(right: _screenSizeWidth * 0.02, left: _screenSizeWidth * 0.02),
                                  //alignment: const Alignment(0.0, 0.0), //真ん中に配置
                                  decoration: BoxDecoration(
                                    color: Constant.glay,
